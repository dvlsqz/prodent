...
class RecetasController extends Controller
{
  ...
  public function show($id){
    ...
    $doctor = Doctores::findOrFail($receta->doctor_id);
    $paciente = Pacientes::findOrFail($receta->paciente_id);
    $medicamento = Medicamentos::findOrFail($receta->medicamento_id);
    return view("recetas.show",["receta"=>$receta, "doctor"=>$doctor, "paciente"=>$paciente, "medicamento"=>$medicamento]);
  }
